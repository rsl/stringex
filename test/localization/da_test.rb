  ...
  def test_character_conversion
    {
      ...
      assert_equal converted, original.convert_miscellaneous_characters, "Conversion of \"#{original}\""
    end
  end
  ...
  def test_html_entity_conversion
    {
      ...
      assert_equal converted, original.convert_miscellaneous_html_entities, "Conversion of \"#{original}\""
    end
  end

  def test_vulgar_fractions_conversion
    {
      "&frac12;" => "halv",
      "½" => "halv",
      "&#189;" => "halv",
      ...
      assert_equal converted, original.convert_vulgar_fractions, "Conversion of \"#{original}\""
    end
  end
end
