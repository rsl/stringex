...
<tt>:enforce_uniqueness_on_sti_base_class</tt>:: If set to true, when using STI, unique urls will be enforced
                                                 across all child classes. Default is false. <em>NOTE: This option
                                                 will have no effect if <tt>:allow_duplicates</tt> is set to true.</em>
