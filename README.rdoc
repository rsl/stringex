...
When using Stringex with Ruby on Rails, you get automatically get built-in translations for miscellaneous characters, HTML entities, and vulgar fractions.
